...
df_customers.to_csv("data/raw/src_customers.csv", index=False)
...
df_transactions.to_csv("data/raw/src_billing_transactions.csv", index=False)
...
df_sessions.to_csv("data/raw/src_network_sessions.csv", index=False)
